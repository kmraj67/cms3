    ...
    <tbody>
        <tr>
            <td style="line-height:23px;">
                ...
                <div style="color:#4d4d4d; margin-top:10px;">Your account has been temporarily been deactivated. Please contact administrator at <?= SUPPORT_EMAIL ?> for further assistance.</div>
            </td>
        </tr>
